...
<head>
    ...
    <title>Apotik Nuril Zamani</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo base_url(); ?>/assets/dist/img/baru.png" alt="baru"
                height="60" width="60">
        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; Tanggal 05 Agustus 2023 <a href="https://adminlte.io">Tugas Uas pemrograman
                    web</a>.</strong>
            Semoga Sukses:)
